...
echo "=========================================="
echo "🚀 Starting YOLOv8n Full Taxonomy Training"
echo "=========================================="
...
# ~/Models/hierarchical_yolo_models/ultralytics_yolov8n_flat_level_000/1.0.0/weights/best.pt
yolo train \
...
# The combination of 'project' and 'name' guarantees the model saves to:
# ~/Models/hierarchical_yolo_models/ultralytics_yolov8n_flat_level_leaf/1.0.0/weights/best.pt
yolo train \
...
# ~/Models/hierarchical_yolo_models/ultralytics_yolov8n_hierarchical/1.0.0/curriculum_depth_017/weights/best.pt
