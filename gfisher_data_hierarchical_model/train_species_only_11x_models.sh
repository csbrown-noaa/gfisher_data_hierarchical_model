...
echo "=========================================="
echo "🚀 Starting YOLOv11x Species-Only Training"
echo "=========================================="
...
# ~/Models/hierarchical_yolo_species_only_models/ultralytics_yolov11x_flat_level_000/1.0.0/weights/best.pt
yolo train \
...
# The combination of 'project' and 'name' guarantees the model saves to:
# ~/Models/hierarchical_yolo_species_only_models/ultralytics_yolov11x_flat_level_leaf/1.0.0/weights/best.pt
yolo train \
...
# ~/Models/hierarchical_yolo_species_only_models/ultralytics_yolov11x_hierarchical/1.0.0/curriculum_depth_017/weights/best.pt
